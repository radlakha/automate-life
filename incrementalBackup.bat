...
REM Usage: fullBackup.bat <backup drive letter> <Optional Laabel> <ROBOCOPY options>
...
@echo "Backup of %cd% to %1:\%mydate% - Incremental Backup - %~2"
...
ROBOCOPY "." "%1:\%mydate% - Incremental Backup - %~2" %3 /A /M /E /XA:SH /R:2 /W:2 /REG /A-:SH /XD $RECYCLE.BIN "System Volume Information"
